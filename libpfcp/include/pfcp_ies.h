...
#define PFCP_IE_FRWDNG_PARMS (4)
#define PFCP_IE_DUPNG_PARMS (5)
...
#define PFCP_IE_UPD_FRWDNG_PARMS (11)
#define PFCP_IE_UPD_BAR_SESS_RPT_RSP (12)
...
#define PFCP_IE_DEST_INTRFACE_ID (42)
#define PFCP_IE_APPLY_ACTION_ID (44)
...
#define PFCP_IE_APP_DET_INFO (68)
...
#define PFCP_IE_USAGE_RPT_SESS_MOD_RSP (78)
#define PFCP_IE_USAGE_RPT_SESS_DEL_RSP (79)
#define PFCP_IE_USAGE_RPT_SESS_RPT_REQ (80)
#define PFCP_IE_URR_ID (81)
#define PFCP_IE_LINKED_URR_ID (82)
#define PFCP_IE_DNLNK_DATA_RPT (83)
#define PFCP_IE_OUTER_HDR_CREATION (84)
#define PFCP_IE_CREATE_BAR (85)
#define PFCP_IE_UPD_BAR_SESS_MOD_REQ (86)
...
#define PFCP_IE_CREATE_TRAFFIC_ENDPT (127)
#define PFCP_IE_CREATED_TRAFFIC_ENDPT (128)
#define PFCP_IE_UPD_TRAFFIC_ENDPT (129)
#define PFCP_IE_RMV_TRAFFIC_ENDPT (130)
#define PFCP_IE_TRAFFIC_ENDPT_ID (131)
#define PFCP_IE_ETH_PCKT_FLTR (132)
